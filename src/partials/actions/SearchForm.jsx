  ...
  const getSearchTerm  =() => {
   ...
   return (
    <form className="relative">
      ...
      <input id="action-search" className="form-input pl-9 focus:border-slate-300" type="search" ref={inputEl} value={props.term} onChange={getSearchTerm}  placeholder={props.placeholder} />
